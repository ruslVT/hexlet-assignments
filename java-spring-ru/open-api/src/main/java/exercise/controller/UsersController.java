...
public class UsersController {
    ...
    public void updateUser(@Parameter(description = "Id of user to be updating") @PathVariable long id,
                           @Parameter(description = "New data of user") @RequestBody User user) {
        if (!userRepository.existsById(id)) {
            throw new UserNotFoundException(id);
        }
